...
1. **Concurrency**: If the heartbeat wakes up every 5 seconds and the previous execution did not finish yet, the messages from the previous run should not be consumed again.
