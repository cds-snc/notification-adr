...
Another option could be to buy a pool of 1,000 Canadian numbers. These comes at a cost of 1 USD / month / number, replicating the same cost of a short code. We would get a much higher rate by rotating through our own numbers and would have total control over it. There would be an application logic overhead that we would need to write, such as a round-robin strategy with certain range of dedicated reserved numbers for service that require trust.
