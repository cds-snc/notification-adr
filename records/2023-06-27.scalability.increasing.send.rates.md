...
_**TODO**: Investigate what makes up the time for the `deliver_email` before calling `send_email`_.
...
| Infrastructure | [Concurrent Celery workers](#concurrent-celery-workers)                                   |                                                                                                                                                                                                                                                                               |
| Code           | [Split Celery worker types](#split-celery-worker-types]                                   |                                                                                                                                                                                                                                                                               |
...
| Code           | [Align SMS pipeline with priority queues](#align-sms-pipeline-with-priority-queues)       |                                                                                                                                                                                                                                                                               |
...
It is likely that increasing our capacity to send will induce an increase in cost. We will fill in
...
_TODO: Describe the way forward, along with optimization process._
