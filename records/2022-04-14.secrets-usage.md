...
| API Keys                                                                   | Yes        | Yes            | Signed into the database.                                                                                                       | 1. [Model ApiKey.secret](https://github.com/cds-snc/notification-api/blob/9461b26f9582bdea6fe7c68b3d360597e5eab9ba/app/models.py#L928)                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
2. Provide a mechanism to rotate secret and salt with overlapping support for old and new keys as [suggested by the itsdangerous library](https://itsdangerous.palletsprojects.com/en/2.1.x/concepts/#key-rotation).
