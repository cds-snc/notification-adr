...
|                     | Fine Grained RBAC | Multiple Secret Stores | Multiple Secret  Backends | Automatic Secret Rotation | Just In Time Authentication | Cloud Agnostic | Managed Service | License Cost | People-Time Cost | Infrastructure Cost |
|---------------------|-------------------|------------------------|---------------------------|---------------------------|-----------------------------|----------------|-----------------|--------------|------------------|---------------------|
| HCP Vault           | Yes               | Yes                    | Yes                       | Yes                       | Yes                         | Yes            | Yes             | ~ $20k/Year  | Low              | Included w/ License |
| Self Hosted Vault   | Yes               | Yes                    | Yes                       | Yes                       | Yes                         | Yes            | No              | Free         | High             | Medium              |
| AWS Secrets Manager | Yes               | No (One per account)   | No                        | Yes                       | No                          | No             | Yes             | Free         | Medium           | Low                 |
| AWS Parameter Store | Yes               | No (One per account)   | No                        | No                        | No                          | No             | Yes             | Free         | Medium           | Free                |
