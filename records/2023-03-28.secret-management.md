...
[https://developer.hashicorp.com/vault/tutorials/kubernetes/kubernetes-external-vault](Kubernetes Integration is done via the vault secret injector combined with the vault sidecar.)
...
[https://developer.hashicorp.com/vault/tutorials/app-integration/aws-lambda#vault_auth_role](AWS Lamba Integration is done via the Vault Lambda extension.)
...
[https://www.hashicorp.com/products/vault/pricing](There are different pricing tiers for HCP Vault based on operational requiremments.) The highest tier of HCP Vault would cost approximately $22k CAD per year. This cost could be split across the entirety of CDS and create a unified secret managemment platform. 
