...
$$\text{Bounce Rate} = \frac{\sum\limits_{n=1}^{24} \text{hard\textunderscore bounces\textunderscore n} +\text{length}( \text{hard\_bounces:\{service\_id\}} )}{\sum\limits_{n=1}^{24} \text{total\textunderscore notifications\textunderscore n} + \text{length}( \text{total\_notifications:\{service\_id\}} )}$$
