...
$$Bounce Rate = \frac{\sum\limits_{n=1}^{24} \text{hard\textunderscore bounces\textunderscore n} +\text{length}( \text{hard\textunderscore bounces:\{service\textunderscore id\}} )}{\sum\limits_{n=1}^{24} \text{total\textunderscore notifications\textunderscore n} + \text{length}( \text{total\textunderscore notifications:\{service\textunderscore id\}} )}$$
